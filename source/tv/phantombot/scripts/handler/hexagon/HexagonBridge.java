...
public class HexagonBridge {
    ...
    private final ExponentialBackoff backoff = new ExponentialBackoff(1000, 2 * 60 * 1000, 2);
    ...
    public void setLevel(int level) throws HexagonBridgeException {
        ...
        log(String.format("Setting speed to level %s (%s / %s)", level, dutyCycle, MAX_SPEED));
        if (socket == null) {
        ...
        try {
            ...
            if (response != null) {
                com.gmt2001.Console.err.println(responseToString(response));
            }
        } catch (IOException e) {
            ...
            while (!stopRequested) {
                try {
                    ...
                    if (socket == null) {
                        ...
                        com.gmt2001.Console.debug.println("Hexagon Bridge connected");
                    }
                    ...
                    try {
                        ...
                        //log("IOException. Waiting " + waitingTime + " before retrying to connect");
